"""Unit tests for dags/project2/common/greetings.py -- project2's own copy of
...
def test_where_returns_label_with_hostname(capsys):
    result = where("hello from project2")
    assert result == f"hello from project2 on host={socket.gethostname()}"
